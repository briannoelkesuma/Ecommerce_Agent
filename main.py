...
def admin_main():
    ...
    st.markdown("Welcome to the Admin Dashboard. Here you can manage products, view orders, and more.")

    # Example admin functionalities
    if st.button("View All Orders"):
        # Logic to fetch and display all orders
        orders = get_all_orders()  # You would implement this function
        st.write(orders)

    if st.button("Manage Products"):
        # Logic to add, update, or delete products
        manage_products()  # You would implement this function
...
def main():
    ...
    # Add a toggle for user/admin view
    view_choice = st.radio("Select View:", ("User", "Admin"))
